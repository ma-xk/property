      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            <div className="text-white">Loading place details...</div>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center py-12">
            <div className="text-red-400">Error: {error || "Place not found"}</div>
            <Button 
              onClick={() => router.push('/')} 
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          ...
          <nav className="flex items-center space-x-2 text-sm bg-white/5 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/10">
            ...
            <span className="text-white font-medium px-2 py-1 bg-white/5 rounded truncate max-w-xs" title={place.name}>
              {place.name}
            </span>
          </nav>
        ...
        {place.description && (
          ...
          >
            <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
              ...
              <CardContent>
                <div className="text-slate-300 leading-relaxed">{place.description}</div>
                <div className="flex items-center gap-6 text-sm text-slate-400 mt-4 pt-4 border-t border-white/10">
        ...
        >
          <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-white">{place.properties.length}</div>
            </CardContent>
          </Card>

          <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
            <CardHeader className="pb-2">
              <CardTitle className="text-white text-sm font-medium">Available</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-white">{getAvailableProperties()}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-white">{getTotalAcres().toFixed(1)}</div>
            </CardContent>
          </Card>
        </motion.div>
        ...
        {getTotalTaxes() > 0 && (
          ...
          >
            <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-white">{formatCurrency(getTotalTaxes())}</div>
              </CardContent>
            </Card>

            <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
              <CardHeader className="pb-2">
                <CardTitle className="text-white text-sm font-medium">Property Types</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
              <CardHeader className="pb-2">
                <CardTitle className="text-white text-sm font-medium">Avg. Price/Acre</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-lg font-bold text-white">
        ...
        >
          <Card className="bg-white/10 border-white/20 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-white">Properties in {place.name}</CardTitle>
            </CardHeader>
            <CardContent>
